...
const NewsletterSection = ({ linkOptions, socialCardsData }: Props) => {
  return (
    <div
      className={`box-border flex shrink-0 grow-0 basis-auto flex-row items-start justify-start gap-[127px] border border-solid border-[black] px-[47px] pb-14 pt-12`}
    >
      <div
        className={`box-border flex shrink-0 grow basis-[502px] flex-col items-stretch justify-start gap-[23px] pb-[14.5px]`}
      >
        <div
        ...
        <div
          className={`box-border flex shrink-0 grow-0 basis-auto flex-row items-end justify-start`}
        >
          <TextField
            hiddenLabel
          ...
          <Button className="ml-3.5 box-border block h-[50px] w-[121px] shrink-0 grow-0 basis-auto  cursor-pointer rounded-[5px] border border-solid border-[black] bg-transparent text-base font-normal text-[black]">
            Subscribe
          </Button>
        </div>
        <p
          className={`-mt-2 box-border max-w-[481px] shrink-0 grow-0  basis-auto text-xs font-normal leading-[128%] text-[black]`}
        >
      ...
      <div
        className={`box-border flex w-[309px] shrink-0 grow basis-[309px] flex-col items-stretch justify-start`}
      >
        <div
          className={`box-border flex shrink-0 grow-0 basis-auto flex-row items-stretch justify-start`}
        >
          <p
            className={`box-border w-[62.82%] shrink-0 grow-0 basis-auto  text-base font-semibold text-[black]`}
          >
            Column Two
          </p>
          <p
            className={`box-border  w-[37.18%] shrink-0 grow-0 basis-auto px-[15px] text-base font-semibold text-[black]`}
          >
            Follow Us
          </p>
        </div>
        ...
        <p
          className={`mt-1 box-border shrink-0 grow-0  basis-auto text-sm font-normal text-[black]`}
        >
          Link Ten
        </p>
      </div>
