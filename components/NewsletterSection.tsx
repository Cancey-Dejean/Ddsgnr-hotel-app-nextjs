...
const NewsletterSection = ({ linkOptions, socialCardsData }: Props) => {
  return (
    <div
      className={`border flex justify-start items-start flex-row gap-[127px] grow-0 shrink-0 basis-auto box-border pt-12 pb-14 px-[47px] border-[black] border-solid`}
    >
      <div
        className={`flex justify-start items-stretch flex-col gap-[23px] grow shrink-0 basis-[502px] box-border pb-[14.5px]`}
      >
        <div
        ...
        <div
          className={`flex justify-start items-end flex-row grow-0 shrink-0 basis-auto box-border`}
        >
          <TextField
            hiddenLabel
          ...
          <Button className="w-[121px] h-[50px] grow-0 shrink-0 basis-auto box-border border bg-transparent  text-base font-normal text-[black] cursor-pointer block ml-3.5 rounded-[5px] border-[black] border-solid">
            Subscribe
          </Button>
        </div>
        <p
          className={`max-w-[481px] grow-0 shrink-0 basis-auto box-border  text-xs font-normal leading-[128%] text-[black] -mt-2`}
        >
          By subscribing you agree to with our
          <span
            className={`[font-family:Roboto] text-xs font-normal leading-[128%] underline`}
          >
            Privacy Policy
          </span>
      ...
      <div className={`grow-0 shrink-0 basis-auto box-border`}>
        <p className={`box-border  text-base font-semibold text-[black]`}>
          Column One
        </p>
        <LinkList linkOptions={linkOptions} />
      </div>
      <div
        className={`flex justify-start items-stretch flex-col w-[309px] grow shrink-0 basis-[309px] box-border`}
      >
        <div
          className={`flex justify-start items-stretch flex-row grow-0 shrink-0 basis-auto box-border`}
        >
          <p
            className={`w-[62.82%] grow-0 shrink-0 basis-auto box-border  text-base font-semibold text-[black]`}
          >
            Column Two
          </p>
          <p
            className={`box-border  text-base font-semibold text-[black] w-[37.18%] grow-0 shrink-0 basis-auto px-[15px]`}
          >
            Follow Us
          </p>
        </div>
        ...
        <p
          className={`grow-0 shrink-0 basis-auto box-border  text-sm font-normal text-[black] mt-1`}
        >
          Link Ten
        </p>
      </div>
