...
const VacationSection = (props: Props) => {
  return (
    <div
      className={`bg-[white] flex justify-start items-stretch flex-row box-border px-16 py-28`}
    >
      <div
        className={`[background:url(https://s3-alpha-sig.figma.com/img/eac4/4920/61a6671ca9308b80cdc80491fc111dfc?Expires=1693785600&Signature=SUP0RFtpWLWMjQ~~zQJlwZxIZNSGyDxerY4qFCWPD6ApzwsskBiJodBFRi4XjHctAQ2vQ9m~-HmTB~5pNwVkDSxKkbJ7qlKlw4hVldpemClByrUb0XMSofECLWtSAhcGzapWWP9l-5yFk6BESBHXd7F1N-7jqXnyc9mVhdzx5bgyoGyj7OMNkjOIZ8zE6rEMVFjPrsyXLYe2K62aq3KPPS2MgUrmy6L~G6Zvg2kbWykf1JZQouWRqMKDYxCgQkFyBOJWXq1ukFkD0UXpbPtgRKbwg~fsX90GVXaab6lbiV1O9h~lXCOjdne2i65g3E~cVk5qWnZC9OsTzuNYE9gAWw\_\_&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4)] bg-cover bg-no-repeat flex justify-center items-center flex-col w-[51.83%] grow-0 shrink-0 basis-auto box-border pt-[269px] pb-[268px]`}
      >
        <img
      ...
      <div
        className={`flex justify-center items-stretch flex-col w-[48.17%] grow-0 shrink-0 basis-auto box-border pt-[70px] pb-[57px] px-[15px]`}
      >
        {/* Vacation Details */}
        <div
          className={`flex justify-center items-stretch flex-col grow-0 shrink-0 basis-auto box-border`}
        >
          {/* Vacation Section */}
          <div
            className={`flex justify-center items-stretch flex-col grow-0 shrink-0 basis-auto box-border`}
          >
            <VacationFeatures />
            <div
              className={`ml-[-6.5px] mr-[-6.5px] flex justify-end items-start flex-row grow-0 shrink-0 basis-auto box-border mt-4`}
            >
              <p
                className={`grow shrink basis-[0.00] box-border text-base font-normal leading-[128%] text-[black] mr-[33px]`}
              >
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Suspendisse varius enim in eros.
              </p>
              <p
                className={`grow shrink basis-[0.00] box-border text-base font-normal leading-[128%] text-[black]`}
              >
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Suspendisse varius enim in eros.
              </p>
          ...
          >
            ...
            >
              ...
              <div
                className={`flex justify-start items-stretch flex-row grow-0 shrink-0 basis-auto box-border mt-5`}
              >
                <p
                  className={`w-[50.83%] grow-0 shrink-0 basis-auto box-border text-2xl font-bold text-[black]`}
                >
                  Gym
                </p>
                <p
                  className={`box-border text-2xl font-bold text-[black] w-[49.17%] grow-0 shrink-0 basis-auto px-[15px]`}
                >
                  Resturant
                </p>
              </div>
        ...
        <div
          className={`flex justify-start items-center flex-row grow-0 shrink-0 basis-auto box-border mt-[47px]`}
        >
          {/* Button Component starts here. We've generated code using MUI Base. See other options in "Component library" dropdown in Settings */}
          <Button className="w-[123px] h-[50px] grow-0 shrink-0 basis-auto box-border border bg-transparent text-base font-normal text-[black] cursor-pointer block rounded-[5px] border-[black] border-solid">
            Book Now
          </Button>
