      ...
      >
        ...
        >
          ...
          >
            <VacationFeatures />
            <div
              className={`ml-[-6.5px] mr-[-6.5px] mt-4 box-border flex shrink-0 grow-0 basis-auto flex-row items-start justify-end`}
            >
              <p
                className={`mr-[33px] box-border shrink grow basis-[0.00] text-base font-normal leading-[128%] text-[black]`}
              >
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Suspendisse varius enim in eros.
              </p>
              <p
                className={`box-border shrink grow basis-[0.00] text-base font-normal leading-[128%] text-[black]`}
              >
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Suspendisse varius enim in eros.
              </p>
          ...
          >
            ...
            >
              ...
              <div
                className={`mt-5 box-border flex shrink-0 grow-0 basis-auto flex-row items-stretch justify-start`}
              >
                <p
                  className={`box-border w-[50.83%] shrink-0 grow-0 basis-auto text-2xl font-bold text-[black]`}
                >
                  Gym
                </p>
                <p
                  className={`box-border w-[49.17%] shrink-0 grow-0 basis-auto px-[15px] text-2xl font-bold text-[black]`}
                >
                  Resturant
                </p>
              </div>
        ...
        <div
          className={`mt-[47px] box-border flex shrink-0 grow-0 basis-auto flex-row items-center justify-start`}
        >
          {/* Button Component starts here. We've generated code using MUI Base. See other options in "Component library" dropdown in Settings */}
          <Button className="box-border block h-[50px] w-[123px] shrink-0 grow-0 basis-auto cursor-pointer rounded-[5px] border border-solid border-[black] bg-transparent text-base font-normal text-[black]">
            Book Now
          </Button>
